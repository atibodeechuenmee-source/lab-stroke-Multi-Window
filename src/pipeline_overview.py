...
STAGES: tuple[PipelineStage, ...] = (
    ...
    PipelineStage(
        ...
        inputs=(Path("data/raw/patients_with_tc_hdl_ratio_with_drugflag.xlsx"),),
        outputs=(),
        command=None,
        implemented=False,
    ),
    PipelineStage(
        ...
        outputs=(Path("output/eda_output"),),
    ...
    PipelineStage(
        ...
        outputs=(Path("output/feature_importance_output"), Path("output/model_output")),
        command=None,
    ),
    PipelineStage(
        order=7,
        ...
        inputs=(Path("data/raw/patients_with_tc_hdl_ratio_with_drugflag.xlsx"), Path("src/feature_importance.py")),
        outputs=(Path("output/feature_importance_output"),),
    ...
    PipelineStage(
        ...
        inputs=(Path("output/feature_importance_output"), Path("output/model_output")),
        outputs=(
            Path("output/feature_importance_output/model_holdout_metrics.csv"),
